...
namespace SMS.Infrastructure.Data
{
    ...
    /// </summary>
    public class ApplicationDbContextV1 : DbContext
    {
        public ApplicationDbContextV1(DbContextOptions<ApplicationDbContext> options) : base(options) { }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FamilyMember>()
                .HasOne(fm => fm.Relationship)
                .WithMany(r => r.FamilyMembers)
                .HasForeignKey(fm => fm.RelationshipId);
            ...
            modelBuilder.Entity<Student>().HasData(
                new Student { ID = 1, FirstName = "John", LastName = "Doe", DateOfBirth = new DateTime(2000, 3, 15), Status = "Active", NationalityId = 1 },
                new Student { ID = 2, FirstName = "Jane", LastName = "Smith", DateOfBirth = new DateTime(1983, 1, 11), Status = "Active", NationalityId = 5 },
                new Student { ID = 3, FirstName = "Leanne", LastName = "Graham", DateOfBirth = new DateTime(2010, 7, 1), Status = "Active", NationalityId = 97 },
                new Student { ID = 4, FirstName = "Dennis", LastName = "Schulist", DateOfBirth = new DateTime(1798, 12, 31), Status = "Active", NationalityId = 40 },
                new Student { ID = 5, FirstName = "Glenna", LastName = "Reichert", DateOfBirth = new DateTime(2000, 10, 19), Status = "Active", NationalityId = 9 },
                new Student { ID = 6, FirstName = "Ervin", LastName = "Howell", DateOfBirth = new DateTime(2004, 4, 24), Status = "Active", NationalityId = 77 }
            );

            modelBuilder.Entity<FamilyMember>().HasData(
                new FamilyMember { ID = 1, StudentId = 1, FirstName = "Harry", LastName = "Joe", DateOfBirth = new DateTime(1975, 5, 15), NationalityId = 1, RelationshipId = 1 },
                new FamilyMember { ID = 2, StudentId = 2, FirstName = "Jack", LastName = "Connor", DateOfBirth = new DateTime(1983, 10, 21), NationalityId = 5, RelationshipId = 2 },
                new FamilyMember { ID = 3, StudentId = 6, FirstName = "Smith", LastName = "Roberts", DateOfBirth = new DateTime(2013, 7, 1), NationalityId = 97, RelationshipId = 3 },
                new FamilyMember { ID = 4, StudentId = 4, FirstName = "George", LastName = "Rhys", DateOfBirth = new DateTime(1898, 12, 31), NationalityId = 40, RelationshipId = 3 },
                new FamilyMember { ID = 5, StudentId = 5, FirstName = "Alexander", LastName = "Joseph", DateOfBirth = new DateTime(2020, 10, 19), NationalityId = 9, RelationshipId = 1 },
                new FamilyMember { ID = 6, StudentId = 3, FirstName = "William", LastName = "Damian", DateOfBirth = new DateTime(2017, 4, 28), NationalityId = 77, RelationshipId = 2 }
            );
